            ...
            <div class="form-group">
                ...
                <div class="form-field">
                    <div class="form-control justify-between">
                        ...
                        <label class="form-label">
                            <a class="link link-underline-hover text-gray-500 text-sm">Forgot your password?</a>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-field">
                    <div class="form-control">
                        ...
                        <a href="/register" class="link link-underline-hover text-gray-500 text-sm">Sign in</a>
                    </div>
                </div>
            </div>
        </form>
